# yildiz 1.18.0 HttpServer CURL Examples
...
```shell
    # Request:
    curl 'http://localhost:45456/translator/translate-and-store' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"value":"e5c4850b-783e-49de-852d-7ffc8b0fac0d","data":{"bla":"blup","xd":123,"derp":1.2,"hihi":false},"ttld":true}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/translator/1676024552' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/node' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"identifier":1676024552,"data":{"bla":"blup"},"ttld":true}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/node/1676024552' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/node' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"identifier":1792091071,"data":{"bla":"blup 2"}}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/17/18/test' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"leftId":17,"rightId":18,"relation":"test","attributes":{"taschen":"voller lila"},"_extend":{},"ttld":true}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"leftId":17,"rightId":18,"relation":"test","attributes":{"taschen":"voller lila zum quadrat"},"_extend":{}}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"leftId":18,"rightId":17,"relation":"test","attributes":{"taschen":"voller lila zum quadrat swapped"},"_extend":{}}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/left/17/test' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/right/17/test' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/both/17/test' -H 'x-yildiz-prefix: http_test' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/depth/increase' -X PUT -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"leftId":17,"rightId":18,"relation":3127628307}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/depth/decrease' -X PUT -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"leftId":17,"rightId":18,"relation":"test"}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/access/translated-edge-info' -H 'content-type: application/json' -H 'x-yildiz-prefix: http_test' --data-binary '{"values":["e5c4850b-783e-49de-852d-7ffc8b0fac0d","e8cdaaab-e799-4276-9ae1-484f2af2dc7e"]}' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/edge/17/18/test' -X DELETE -H 'x-yildiz-prefix: http_test' -H 'content-length: 0' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/node/1676024552' -X DELETE -H 'x-yildiz-prefix: http_test' -H 'content-length: 0' --compressed
...
```shell
    # Request:
    curl 'http://localhost:45456/translator/1676024552' -X DELETE -H 'x-yildiz-prefix: http_test' -H 'content-length: 0' --compressed
