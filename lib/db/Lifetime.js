...
class Lifetime {
    ...
    async _job(){
        ...
        //first translates
        results.push(await this.yildiz.spread(translatesQuery, { seconds: this.options.lifeTimeInSec }));
        
        //then edges
        results.push(await this.yildiz.spread(edgesQuery, { seconds: this.options.lifeTimeInSec }));

        //second nodes
        results.push(await this.yildiz.spread(nodesQuery, { seconds: this.options.lifeTimeInSec }));
