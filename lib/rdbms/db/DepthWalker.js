...
class DepthWalker {
    ...
    async _walk(){
        ...
        this.yildiz.incStat("depth_walker_total_walks");
        this.yildiz.incStat("depth_walker_total_edges", edgeIds.length);
        ...
        this.yildiz.setGaugeStat("depth_walker_runtime", diff);
        debug("done", diff, "ms needed for", edgeIds.length, "edge updates.");
    }
