...
class GraphAccess {
    ...
    async upsertSingleEdgeRelationBetweenNodes(body, withTransaction = true){
        ...
        //TODO: enable cachjinmg for getNodeByIdentifier
        ...
        if (!depthBeforeCreation) {
            ...
            //TODO: enable caching for edge exists id
            edge = await this.nodeHandler.getEdgeByIdentifier(nodeLeft.id + "_" + nodeRight.id + "_" + strToInt(relation));
