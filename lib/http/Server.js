...
class Server {
    ...
    _init() {
        ...
        this.app.use((req, res, next) => {
            ...
            const authcode = this.factory.isPrefixWithTokenAllowed(req.headers["x-yildiz-prefix"], req.headers["authorization"]);
            switch(authcode){
        ...
        this.app.setErrorHandler((error, res) => {
            ...
            //TODO this catches not found errors and should return 404
